...
<body>
	<div class="container">
		<div class="row">
				...
				<div class="box_border">
					...
					<div class="box_center pt10 pb10">
						<table class="form_table" border="0" cellpadding="0"
							cellspacing="0">
							<input type="hidden" name="divisionId" id="divisionId" value="${searchModelOrg.divisionId}">
							<input type="hidden" name="orgId" id="orgId" value="${searchModel.orgId}">
			...
			<input type="button" onclick="javascript:openPage('./user/new?divisionId=${searchModelOrg.divisionId}&orgId=${searchModel.orgId }');" name="button" class="btn btn82 btn_add"
				value="新增">
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<c:forEach items="${page.list}" var="user" varStatus="status">
						<tr class="tr">
							...
							<td><a href="javascript:openPage('user/edit?code=${user.code }&orgId=${user.orgId }&divisionId=${searchModelOrg.divisionId }');"> 
							${user.name}(${user.loginname })</a></td>
							<td>${user.orgId}</td>
							<td>${user.lastlogintime }</td>
							<td> <a class="ext_btn" href="javascript:viewPage('user/edit?code=${user.code }&orgId=${user.orgId }&divisionId=${searchModelOrg.divisionId }');">  查看
							</a>
							<a class="ext_btn" href="javascript:openPage('user/edit?code=${user.code }&orgId=${user.orgId }&divisionId=${searchModelOrg.divisionId }');">  编辑
							</a>
							</td>
	...
	jQuery(document).ready(function() {
		...
		function selectNodes(){
 				var node = zTree.getNodeByParam("id", "${searchModelOrg.divisionId}", null);

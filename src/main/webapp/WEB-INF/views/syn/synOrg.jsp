		...
		<div id="search_bar" class="mt10">
			<div class="box">
				<div class="box_border">
					<form action="listSynOrg" method="get" id="serchForm">
			...
			<input type="button" onclick="javascript:dialogPage('添加同步机构','listToSynOrg?appId=${appId }',function(){window.location.reload();});" name="button" class="btn btn82 btn_add"
				value="同步">
